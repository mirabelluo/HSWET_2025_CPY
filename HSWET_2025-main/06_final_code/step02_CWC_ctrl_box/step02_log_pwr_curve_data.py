...
# ------------------ [DONT CHANGE] -------------------
# These saves the data to "data_logged" folder
...
# [IMPORTANT] If the values start going crazy, you can stop the code with CTRL+C and save the data
